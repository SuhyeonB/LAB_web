        ...
        <div id="main" className="wrapper style">
            <div className="container">
                <div id="content">
                    ...
                    <div style={{flexWrap: "wrap"}}>
                        <div className="row members">
                            <div className="col-4 col-12-medium mem" style={{textAlign:"center"}}>
                                <h4>OOO</h4>
                                <img alt="m07" style={{borderRadius: "80%", objectFit: "cover", width: "200px"}} src={defaultImg}/>
                            </div>
                            <div className="col-4 col-12-medium mem" style={{textAlign:"center"}}>
                                <h4>OOO</h4>
                                <img alt="m08" style={{borderRadius: "80%", objectFit: "cover", width: "200px"}} src={defaultImg}/>
                            </div>
                            <div className="col-4 col-12-medium mem" style={{textAlign:"center"}}>
                                <h4>OOO</h4>
                                <img alt="m09" style={{borderRadius: "80%", objectFit: "cover", width: "200px"}} src={defaultImg}/>
                            </div>
                        </div>
                    </div>
                </div>
